...
class TrainingDaySchedule:
    def formatlesson(self, lesson: Teach):
        return f"<td><a href='{lesson.get_absolute_url()}' class='block p-2 w-auto min-h-24 h-l bg-clr-1 hover:bg-green-900 rounded-lg shadow-md'>{lesson.format_html_block()}</a></td>"
